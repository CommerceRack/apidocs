define({ "api": [
  ...
  },
  {
    ...
    "group": "cart",
    "description": "<p>Returns parameters necessary for CBA interaction:</p> <ul> <li>merchantid: the checkout by amazon assigned merchantid (referred to as [merchantid] in the example below)</li> <li>b64xml: a base64 encoded xml order object based on the current cart geometry referred to as [b64xml], BUT passed to amazon following &quot;order:&quot;</li> <li>signature: a sha1, base64 encoded concatenation of the b64xml and the configured cba secret key refrerred to as [signature] in the example below, AND passed to amazon following &quot;signature:&quot;</li> <li>aws-access-key-id: a public string cba needs to identify this merchant refrred to as [aws-access-key-id] AND passed to amazon following the &quot;aws-access-key-id:&quot; parameter</li> </ul> <p>To generate/create a payment button, suggested parameters are: color: orange, size: small, background: white <a href=\"https://payments.amazon.com/gp/cba/button?ie=UTF8&amp;color=[color]&amp;background=[background]&amp;size=[size\">https://payments.amazon.com/gp/cba/button?ie=UTF8&amp;color=[color]&amp;background=[background]&amp;size=[size</a>] ex: <a href=\"https://payments.amazon.com/gp/cba/button?ie=UTF8&amp;color=orange&amp;background=white&amp;size=small\">https://payments.amazon.com/gp/cba/button?ie=UTF8&amp;color=orange&amp;background=white&amp;size=small</a> Use this as the <strong>your button image url</strong> in the example.</p> <p>The [formurl] is created by the developer using the merchant id, specify either sandbox or non-sandbox (live): <a href=\"https://payments.amazon.com/checkout/[merchantid\">https://payments.amazon.com/checkout/[merchantid</a>] <a href=\"https://payments-sandbox.amazon.com/checkout/[merchantid]?debug=true\">https://payments-sandbox.amazon.com/checkout/[merchantid]?debug=true</a></p> ",
    "parameter": {
      "fields": {
        "Request": [
          {
          ...
          },
          {
            ...
            "description": "<p>URL where user can be directed to by amazon if they wish to lookup order status. (don&#39;t stress about this, rarely used)</p> "
          }
        ]
      }
    },
        ...
        "Response": [
          {
            ...
            "optional": false,
            "field": "merchantid",
            "description": "<p>variable to be interpolated into amazon payments button html</p> "
          },
          {
            "group": "Response",
            "type": "String",
